...
export function Impressum() {
  return (
    <div id="impressum" className="overflow-hidden transition-all duration-700">
        ...
        <nav className="flex flex-row items-center font-bold justify-between px-7 p-4.5 max-w-180 mx-auto">
          ...
          <div className="hidden md:block">
            <button
              ...
              className="bg-transparent font-monospace flex items-center gap-1.5 text-[0.82rem] font-light text-ink-soft hover:text-ink px-5 py-2.5"
            >
      ...
      <section className="overflow-hidden pt-5 md:py-15 transition-all duration-700">
        <div className="flex flex-col px-5 text-ink-soft text-[0.96rem] mb-0 max-w-180 mx-auto">
          ...
          <p>
            E-Mail:
            <a className="text-blue pl-2" href="mailto:hallo@milantyopity.com">
              hallo@milantyopity.com
            </a>
          </p>
          <p>
            Telefon:
            <a className="text-blue pl-2" href="tel:+4915784590727">
              +49 1578 4590727
            </a>
          </p>
